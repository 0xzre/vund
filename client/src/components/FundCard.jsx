        ...
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            ...
            <div className='flex flex-col p-4'>
                ...
                <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
                    ...
                    <div className='flex flex-col'>
                        <h4 className='font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]'>{Math.abs(remainingDays)}</h4>
                ...
                <div className='items-center flex mt-[20px] gap-[12px]'>
                    <div className='w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#fb2778]'>
